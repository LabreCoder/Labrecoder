...
<a href="https://tryhackme.com/p/LabreCoder">
  <img src="https://tryhackme-badges.s3.amazonaws.com/LabreCoder.png" alt="TryHackMe Badge">
</a>
...
## 🔓 Security Toolkit
> `STATUS: LEARNING TO HACK (ETHICALLY)`
...
### • UFF
  This space will serve as a place for me to post my solutions to the exercises assigned during the course, as well as to discuss the projects I have been involved in.

  🔗 [GitHub](https://github.com/LabreCoder/UFF)
...
### • WordCollector
  ...
  **WordCollector** is an automation project that searches for a word using a public API, retrieves its definitions and usage examples, stores the data in a local database, and sends the results by email.
  ...
  🔗 [GitHub](https://github.com/LabreCoder/WordCollector)

---

### • Bank_of_ideas
  The **Bank_of_ideas** is a system I created to record my ideas — both creative and non-creative — so I don't lose those moments of insight. This allows me to analyze the idea later and implement it.

  🔗 [GitHub](https://github.com/LabreCoder/Bank_of_ideas)
...
<div align="center">
  ...
  <!--
    Espaço reservado para outros perfis que você queira adicionar futuramente, exemplos:
    <a href="LINK_HACKERRANK"><img alt="HackerRank" src="https://img.shields.io/badge/HackerRank-2EC866?style=for-the-badge&logo=HackerRank&logoColor=white"/></a>
    <a href="LINK_LEETCODE"><img alt="LeetCode" src="https://img.shields.io/badge/LeetCode-F79F1F?style=for-the-badge&logo=LeetCode&logoColor=white"/></a>
    <a href="LINK_TRYHACKME"><img alt="TryHackMe" src="https://img.shields.io/badge/TryHackMe-212C42?style=for-the-badge&logo=tryhackme&logoColor=white"/></a>
    <a href="LINK_CISCO"><img alt="Cisco Networking Academy" src="https://img.shields.io/badge/Cisco-1BA0D7?style=for-the-badge&logo=cisco&logoColor=white"/></a>
  -->
</div>
